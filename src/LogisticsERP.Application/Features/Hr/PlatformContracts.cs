...
public sealed record ClientPlatformUpsertRequest(string Code, string NameAr, string NameEn, IReadOnlyList<string> SupportedPaymentModels, string Status, string? Notes, string? RowVersion);
public sealed record ClientPlatformResponse(Guid Id, string Code, string NameAr, string NameEn, IReadOnlyList<string> SupportedPaymentModels, string Status, string? Notes, string RowVersion);
...
public sealed record AssignPlatformAccountRequest(Guid RiderProfileId, Guid ClientContractId, Guid PlatformRiderAccountId, DateOnly EffectiveFrom, string Status, string? StartReason, string? OperationalAgreementReference, string? OperationalAgreementNotes, bool WasBackdated, string? BackdatedReason);
