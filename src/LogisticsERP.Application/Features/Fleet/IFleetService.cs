...
public interface IFleetService
{
    ...
    Task<Result<IReadOnlyList<FleetLocationResponse>>> GetLocationsAsync(CancellationToken cancellationToken = default);
    Task<Result<FleetLocationResponse>> UpsertLocationAsync(Guid? id, FleetLocationRequest request, CancellationToken cancellationToken = default);
    Task<Result<PagedResponse<VehicleSummaryResponse>>> GetVehiclesAsync(string? search, string? status, Guid? locationId, int page, int pageSize, CancellationToken cancellationToken = default);
    ...
    Task<Result<RiderVehicleAssignmentResponse>> TakeAsync(TakeVehicleRequest request, string idempotencyKey, CancellationToken cancellationToken = default);
    ...
    Task<Result<RiderVehicleAssignmentResponse>> SwitchAsync(SwitchVehicleRequest request, string idempotencyKey, CancellationToken cancellationToken = default);
...
public interface IVehicleFileService
{
    ...
    Task<Result<VehicleAttachmentResponse>> UploadAsync(Guid vehicleId, Guid? attachmentId, VehicleAttachmentCategory category, string displayName, PrivateFileUpload file, CancellationToken cancellationToken = default);
    ...
    Task<Result> ArchiveAsync(Guid vehicleId, Guid attachmentId, ArchiveFleetRequest request, CancellationToken cancellationToken = default);
}
