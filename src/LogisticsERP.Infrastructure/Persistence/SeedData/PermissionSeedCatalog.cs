...
internal static class PermissionSeedCatalog
{
    ...
    [
        ...
        Create(42, PermissionKeys.Operations.HousingRead, "Operations", "عرض السكن", "Read housing", "عرض السكن وفترات الإقامة.", "View housing and residence periods."),
        Create(43, PermissionKeys.Operations.HousingManage, "Operations", "إدارة السكن", "Manage housing", "إدارة السكن والمشرفين وفترات الإقامة.", "Manage housing, supervisors, and residence periods."),
