    ...
    : DbContext(options), IApplicationDbContext
{
    ...
    public DbSet<EmployeeSponsorshipPeriod> EmployeeSponsorshipPeriods => Set<EmployeeSponsorshipPeriod>();
    public DbSet<ResidencyProfession> ResidencyProfessions => Set<ResidencyProfession>();
    public DbSet<EmployeeResidencyPermit> EmployeeResidencyPermits => Set<EmployeeResidencyPermit>();
