    ...
    : DbContext(options), IApplicationDbContext
{
    ...
    public DbSet<FuelCardRiderAssignment> FuelCardRiderAssignments => Set<FuelCardRiderAssignment>();
    public DbSet<FuelCardMonthlyUsage> FuelCardMonthlyUsages => Set<FuelCardMonthlyUsage>();
    public DbSet<FuelCardImport> FuelCardImports => Set<FuelCardImport>();
    public DbSet<MaintenanceLocation> MaintenanceLocations => Set<MaintenanceLocation>();
    public DbSet<InventoryLocation> InventoryLocations => Set<InventoryLocation>();
    public DbSet<InventoryItem> InventoryItems => Set<InventoryItem>();
    public DbSet<MaintenanceSupplier> MaintenanceSuppliers => Set<MaintenanceSupplier>();
    ...
    public DbSet<StockCostAllocation> StockCostAllocations => Set<StockCostAllocation>();
    ...
    public DbSet<OilBarrel> OilBarrels => Set<OilBarrel>();
    public DbSet<OilBarrelUsageAllocation> OilBarrelUsageAllocations => Set<OilBarrelUsageAllocation>();
    public DbSet<OilBarrelLoss> OilBarrelLosses => Set<OilBarrelLoss>();
    ...
    public DbSet<MaintenanceLaborEntry> MaintenanceLaborEntries => Set<MaintenanceLaborEntry>();
    public DbSet<MaintenancePlan> MaintenancePlans => Set<MaintenancePlan>();
    public DbSet<VehicleMaintenanceSchedule> VehicleMaintenanceSchedules => Set<VehicleMaintenanceSchedule>();
    public DbSet<OilChangeOperation> OilChangeOperations => Set<OilChangeOperation>();
    public DbSet<VehicleExpense> VehicleExpenses => Set<VehicleExpense>();
    public DbSet<ExternalPartSaleLine> ExternalPartSaleLines => Set<ExternalPartSaleLine>();
