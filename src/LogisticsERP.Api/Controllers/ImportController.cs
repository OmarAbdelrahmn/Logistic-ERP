    ...
    IVehicleRiderAssignmentImportService vehicleRiderAssignmentImportService) : ControllerBase
{
    ...
    public Task<IActionResult> ValidateExternalRiders(
        ...
        ExecuteExternalRiderImport(request.File, validateOnly: true, cancellationToken);
    ...
    public Task<IActionResult> ImportExternalRiders(
        [FromForm] HrExcelImportForm request,
        CancellationToken cancellationToken) =>
        ExecuteExternalRiderImport(request.File, validateOnly: false, cancellationToken);
    ...
    private async Task<IActionResult> ExecuteExternalRiderImport(
        IFormFile? file,
        bool validateOnly,
        CancellationToken cancellationToken)
    {
        ...
        await using var stream = file.OpenReadStream();
        var result = await externalRiderImportService.ImportAsync(
            stream,
